...
import id.gundar.hi.adapter.AdapterListInbox;
import id.gundar.hi.model.DataGenerator;
import id.gundar.hi.model.Inbox;
import id.gundar.hi.utils.Tools;
import id.gundar.hi.widget.LineItemDecoration;
    ...
    private void initComponent() {
        ...
        mAdapter.setOnClickListener(new AdapterListInbox.OnClickListener() {
            ...
            public void onItemClick(View view, Inbox obj, int pos) {
                    startActivity(new Intent(ListMultiSelection.this,ActivityChat.class));
            }
